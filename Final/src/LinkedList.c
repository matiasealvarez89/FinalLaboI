...
/// @brief Funcion para filtrar la linkedlist con nuevos elementos que pasen el filtro
///
/// @param this linkedlist donde se realiza el filtro
/// @param fn funcion que aplica el criterio del filtro
/// @return nueva linkedlist con los datos filtrados
...
/// @brief funcion para modificar datos dentro de la linkedlist segun un criterio
///
/// @param this linkedlist a modificar
/// @param fn funcion que aplica los criterios para filtrar
/// @return la linkedlist con los datos modificados
...
/// @brief funcion para contar elementos que cumplan cierto criterio
///
/// @param this linkedlist donde se van a contar los elementos
/// @param fn funcion que aplica el criterio
/// @return cantidad de elementos que cumplieron con el criterio
