...
/// @brief funcion para fittrar pokemones que sean de tipo Agua y Varicolor
///
/// @param pArrayListPokemon
void Controller_AguaVaricolor(LinkedList* pArrayListPokemon)
{
	...
	{
		newLinkedList = ll_filter(pArrayListPokemon, Pokemon_AguaVariColor);
		Controller_ListPokemon(newLinkedList);
	}
}

/// @brief Funcion para modificar el ataque cargado de los pokemones que cumplan un criterio
///
/// @param pArrayListPokemon
void Controller_MapearAtaqueCargado(LinkedList* pArrayListPokemon)
{
	...
	if(pArrayListPokemon != NULL)
	{
		ll_map(pArrayListPokemon, (void*)Pokemon_MapearAtaqueCargado);
		Controller_ListPokemon(pArrayListPokemon);
	}
}

/// @brief funcino para contar pokemones que cumplan un criterio
///
/// @param pArrayListPokemon
/// @return cantidad de pokemones que pasaron el filtro
int Controller_CountBatalla(LinkedList* pArrayListPokemon)
{
	...
	if(pArrayListPokemon != NULL)
	{
		retorno = ll_count(pArrayListPokemon, Pokemon_CountBatalla);
	}
	return retorno;
}
